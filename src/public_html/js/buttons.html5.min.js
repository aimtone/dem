...
if(f){c.buttons.info(c.i18n("buttons.copyTitle","Copiado al portapapeles"),c.i18n("buttons.copySuccess",{1:"Copiada una fila al portapapeles",_:"Copiado %d filas al portapapeles"},a.rows),2E3);return}}catch(h){}}f=i("<span>"+c.i18n("buttons.copyKeys","Presiona <i>ctrl</i> o <i>⌘</i> + <i>C</i> para copiar la información de la tabla<br>al portapapeles del sistema.<br><br>Para cancelar, haz click sobre este mensaje o presiona la tecla ESC.")+"</span>").append(d);c.buttons.info(c.i18n("buttons.copyTitle","Copiado al portapapeles"),f,0);b[0].focus();b[0].select();
