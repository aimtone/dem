        app.controller('actos', function($rootScope, $scope, $http, $localStorage, $location, $window) {
            ...
            angular.element(document).ready(function() {
                ...
                setTimeout(function() {
                    ...
                    $('#example').html("<thead><tr><th>Inicio</th><th>Fin</th><th>Sala</th><th>Estatus</th><th>Actividad</th><th>Numero de Causa</th><th>Descripcion de Causa</th><th>Tribunal</th></tr></thead>");
                ...
                columns: [
                    ...
                    //} },
                    {
                        ...
                        render: function(data, type, row) {
                            var start = moment(row.start).format("DD MMMM YYYY hh:mm a");
                            return start;
                        }
                    },
                    {
                        "data": "null",
                        render: function(data, type, row) {
                            var end = moment(row.end).format("DD MMMM YYYY hh:mm a");
                            return end;
                        }
                    },
                    { "data": "sala" },
