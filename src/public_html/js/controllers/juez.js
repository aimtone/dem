                        ...
                        if (response != null) {
                            ...
                            $rootScope.post('api/' + $scope.obj_hijo, $scope.obj).then(function(response) {
                                if (response != null) {
                                    ...
                                    $rootScope.post('api/persona_tipo', { cedula: $scope.persona.cedula, tipo_persona: 5 }).then(function(response) {
                                ...
                                if (response != null) {
                                    $rootScope.post('api/' + $scope.obj_hijo, $scope.obj).then(function(response) {
                                        if (response != null) {
                                            ...
                                            $rootScope.alert("Error", "No se ha registrado los datos, puede que ya exista el registro, por favor, verifique e intente de nuevo", "warning");
                                        }
                                ...
                                $rootScope.delete('api/' + $scope.obj_hijo + '/' + id).then(function(response) {
                                    if (response != null) {
                                        var filter_2 = JSON.stringify({
                                            donde: "WHERE cedula = '" + response["0"].cedula + "' AND tipo_persona = 5"
                                        });
