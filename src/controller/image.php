<?php 
	...
	switch ($_SERVER['REQUEST_METHOD']) {
		...
		case 'POST':
				...
				if($validar==1) {
					$imagen = save_base64_image($array['encodedImage'], "../public_html/images/upload/IMG_" . strtoupper(md5($array['encodedImage'])));
	...
	function save_base64_image($base64_image_string, $output_file_without_extentnion, $path_with_end_slash="" ) {
	    ...
	    chmod($path_with_end_slash . $output_file_with_extentnion, 0777);
